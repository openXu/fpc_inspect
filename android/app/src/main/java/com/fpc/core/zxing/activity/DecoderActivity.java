...
import com.fpc.core.zxing.xuedaojie.qrcodelib.camera.CameraManager;
import com.fpc.core.zxing.xuedaojie.qrcodelib.common.ActionUtils;
import com.fpc.core.zxing.xuedaojie.qrcodelib.common.QrUtils;
import com.fpc.core.zxing.xuedaojie.qrcodelib.decoding.CaptureActivityHandler;
import com.fpc.core.zxing.xuedaojie.qrcodelib.decoding.InactivityTimer;
import com.fpc.core.zxing.xuedaojie.qrcodelib.view.ViewfinderView;
import com.fpc.fpc_inspect.R;
...
public class DecoderActivity extends Activity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        info = (CaptureInfo)getIntent().getSerializableExtra("info");
        Log.e(TAG, "收到info : "+info);
        ...
        setContentView(R.layout.lib_activity_qr_camera);
        initView();
    }
    ...
    protected void onPause() {
        ...
        if (iv_splash != null) {
            iv_splash.setImageResource(R.mipmap.lib_icon_splash_down);
        }
    ...
    protected void initView() {
        ...
        iv_splash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (flashLightOpen) {
                    iv_splash.setImageResource(R.mipmap.lib_icon_splash_up);
                } else {
                    iv_splash.setImageResource(R.mipmap.lib_icon_splash_down);
                }
                toggleFlashLight();
